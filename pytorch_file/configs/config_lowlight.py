...
parser.add_argument('--train_path', dest='train_path', nargs='*',
                    default=r'D:\project\Image-Adaptive-YOLO-main\data\dataset_dark\tielu_train.txt', help='folder of the training data')
parser.add_argument('--test_path', dest='test_path', nargs='*',
                    default=r'D:\project\Image-Adaptive-YOLO-main\data\dataset_dark\tielu_test.txt', help='folder of the training data')
parser.add_argument('--class_name', dest='class_name', nargs='*',
                    default=r'D:\project\Image-Adaptive-YOLO-main\data\classes\tielu_dark.names', help='folder of the training data')
