...
def train():
    ...
    model.train(data="TIELU.yaml", epochs=50, imgsz=640)
...
def test_folders(model_path: str = "/home/youtian/Documents/pro/pyCode/Dedark-YOLO/easy_YOLOv8/train2/weights/best.pt",
                 srcpath: str = "/home/youtian/Documents/pro/pyCode/Dedark-YOLO/pytorch_file/data/test/images",
    ...
    for img_path in src.iterdir():
        ...
        a = Path(dst_folder) / Path(img_path.name)
        cv2.imwrite(str(a), ann)
