...
class YOLOV3(nn.Module):
    ...
    def forward(self, input_data, input_data_clean):
        ...
        return self.pred_sbbox, self.pred_mbbox, self.pred_lbbox, self.image_isped, self.filter_params
    ...
    def bbox_giou(self, boxes1, boxes2):
        ...
        union_area = boxes1_area + boxes2_area - inter_area + 1e-16
    ...
    def loss_layer(self, conv, pred, label, bboxes, anchors, stride):
        ...
        conv = rearrange(conv, 'b (anchor classes) h w -> b h w anchor classes', classes=5 + self.num_class,
                         anchor=self.anchor_per_scale)
