...
parser.add_argument('--test_path', dest='test_path', nargs='*', default='./data/dataset_dark/tielu1386_test.txt',
                    help='folder of the training data')
parser.add_argument('--class_name', dest='class_name', nargs='*', default='./data/classes/tielu_dark.names',
                    help='folder of the training data')
